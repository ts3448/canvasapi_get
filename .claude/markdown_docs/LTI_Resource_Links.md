...
**Caution!** Resource Links are usually managed by the tool that created them via LTI Deep Linking,
...
## [List LTI Resource Links](#method.lti/resource_links.index) [Lti::ResourceLinksController#index](https://github.com/instructure/canvas-lms/blob/master/app/controllers/lti/resource_links_controller.rb)

### GET /api/v1/courses/:course\_id/lti\_resource\_links
...
| --- | --- | --- | --- |
| include\_deleted |  | boolean | Include deleted resource links and links associated with deleted content in response. Default is false. |
| per\_page |  | integer | The number of registrations to return per page. Defaults to 50. |
...
Returns a list of
[Lti::ResourceLink](lti_resource_links.html#Lti::ResourceLink)
objects

## [Show an LTI Resource Link](#method.lti/resource_links.show) [Lti::ResourceLinksController#show](https://github.com/instructure/canvas-lms/blob/master/app/controllers/lti/resource_links_controller.rb)

### GET /api/v1/courses/:course\_id/lti\_resource\_links/:id
...
| Parameter |  | Type | Description |
| --- | --- | --- | --- |
| include\_deleted |  | boolean | Include deleted resource links in search. Default is false. |
...
## [Create an LTI Resource Link](#method.lti/resource_links.create) [Lti::ResourceLinksController#create](https://github.com/instructure/canvas-lms/blob/master/app/controllers/lti/resource_links_controller.rb)

### POST /api/v1/courses/:course\_id/lti\_resource\_links
...
Links created using this API cannot be associated with a specific piece of Canvas content, like an Assignment, Module Item, or Collaboration. Links created using this API are only suitable for embedding in rich content using the âcanvas\_launch\_url` provided in the API response.
...
## [Bulk Create LTI Resource Links](#method.lti/resource_links.bulk_create) [Lti::ResourceLinksController#bulk\_create](https://github.com/instructure/canvas-lms/blob/master/app/controllers/lti/resource_links_controller.rb)

### POST /api/v1/courses/:course\_id/lti\_resource\_links/bulk
...
## [Update an LTI Resource Link](#method.lti/resource_links.update) [Lti::ResourceLinksController#update](https://github.com/instructure/canvas-lms/blob/master/app/controllers/lti/resource_links_controller.rb)

### PUT /api/v1/courses/:course\_id/lti\_resource\_links/:id
...
| include\_deleted |  | boolean | Update link even if it is deleted. Default is false. |
| context\_external\_tool\_id |  | integer | The Canvas identifier for the LTI 1.3 External Tool that the LTI Resource Link was originally installed from. **Caution!** The resource link url must match the toolâs domain or url. |
...
## [Delete an LTI Resource Link](#method.lti/resource_links.destroy) [Lti::ResourceLinksController#destroy](https://github.com/instructure/canvas-lms/blob/master/app/controllers/lti/resource_links_controller.rb)

### DELETE /api/v1/courses/:course\_id/lti\_resource\_links/:id
