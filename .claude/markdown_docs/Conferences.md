...
## [List conferences](#method.conferences.index) [ConferencesController#index](https://github.com/instructure/canvas-lms/blob/master/app/controllers/conferences_controller.rb)

### GET /api/v1/courses/:course\_id/conferences

**Scope:** 
`url:GET|/api/v1/courses/:course_id/conferences`

### GET /api/v1/groups/:group\_id/conferences
...
Returns a list of
[Conference](conferences.html#Conference)
objects

## [List conferences for the current user](#method.conferences.for_user) [ConferencesController#for\_user](https://github.com/instructure/canvas-lms/blob/master/app/controllers/conferences_controller.rb)
