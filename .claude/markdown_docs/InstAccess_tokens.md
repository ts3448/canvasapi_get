...
## [Create InstAccess token](#method.inst_access_tokens.create) [InstAccessTokensController#create](https://github.com/instructure/canvas-lms/blob/master/app/controllers/inst_access_tokens_controller.rb)

### POST /api/v1/inst\_access\_tokens
...
Returns an
[InstAccessToken](inst_access_tokens.html#InstAccessToken)
object