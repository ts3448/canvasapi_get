...
## [List recent history for a user](#method.history.index) [HistoryController#index](https://github.com/instructure/canvas-lms/blob/master/app/controllers/history_controller.rb)

### GET /api/v1/users/:user\_id/history
...
Returns a list of
[HistoryEntry](history.html#HistoryEntry)
objects