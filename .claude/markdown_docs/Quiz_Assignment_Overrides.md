...
## [Retrieve assignment-overridden dates for Classic Quizzes](#method.quizzes/quiz_assignment_overrides.index) [Quizzes::QuizAssignmentOverridesController#index](https://github.com/instructure/canvas-lms/blob/master/app/controllers/quizzes/quiz_assignment_overrides_controller.rb)

### GET /api/v1/courses/:course\_id/quizzes/assignment\_overrides
...
| --- | --- | --- | --- |
| quiz\_assignment\_overrides[][quiz\_ids][] |  | integer | An array of quiz IDs. If omitted, overrides for all quizzes available to the operating user will be returned. |
...
Returns a
[QuizAssignmentOverrideSetContainer](quiz_assignment_overrides.html#QuizAssignmentOverrideSetContainer)
object

## [Retrieve assignment-overridden dates for New Quizzes](#method.quizzes/quiz_assignment_overrides.new_quizzes) [Quizzes::QuizAssignmentOverridesController#new\_quizzes](https://github.com/instructure/canvas-lms/blob/master/app/controllers/quizzes/quiz_assignment_overrides_controller.rb)

### GET /api/v1/courses/:course\_id/new\_quizzes/assignment\_overrides
