...
## [Create a Developer Key Account Binding](#method.developer_key_account_bindings.create_or_update) [DeveloperKeyAccountBindingsController#create\_or\_update](https://github.com/instructure/canvas-lms/blob/master/app/controllers/developer_key_account_bindings_controller.rb)

### POST /api/v1/accounts/:account\_id/developer\_keys/:developer\_key\_id/developer\_key\_account\_bindings
...
| --- | --- | --- | --- |
| workflow\_state |  | string | The workflow state for the binding. Must be one of âonâ, âoffâ, or âallowâ. Defaults to âoffâ. |

Returns a
[DeveloperKeyAccountBinding](developer_key_account_bindings.html#DeveloperKeyAccountBinding)
object