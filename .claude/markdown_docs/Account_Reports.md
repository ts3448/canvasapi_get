...
## [List Available Reports](#method.account_reports.available_reports) [AccountReportsController#available\_reports](https://github.com/instructure/canvas-lms/blob/master/app/controllers/account_reports_controller.rb)

### GET /api/v1/accounts/:account\_id/reports
...
| --- | --- | --- | --- |
| include[] |  | string | Array of additional information to include.  âdescription\_htmlâ  an HTML description of the report, with example output  âparameters\_htmlâ  an HTML form for the report parameters  Allowed values: `description_html`, `params_html` |
...
| parameters[skip\_message] |  | boolean | If true, no message will be sent to the user upon completion of the report. |
| parameters[course\_id] |  | integer | The id of the course to report on. Note: this parameter has been listed to serve as an example and may not be valid for every report. |
...
## [Index of Reports](#method.account_reports.index) [AccountReportsController#index](https://github.com/instructure/canvas-lms/blob/master/app/controllers/account_reports_controller.rb)

### GET /api/v1/accounts/:account\_id/reports/:report
...
## [Status of a Report](#method.account_reports.show) [AccountReportsController#show](https://github.com/instructure/canvas-lms/blob/master/app/controllers/account_reports_controller.rb)

### GET /api/v1/accounts/:account\_id/reports/:report/:id
...
## [Delete a Report](#method.account_reports.destroy) [AccountReportsController#destroy](https://github.com/instructure/canvas-lms/blob/master/app/controllers/account_reports_controller.rb)

### DELETE /api/v1/accounts/:account\_id/reports/:report/:id
...
## [Abort a Report](#method.account_reports.abort) [AccountReportsController#abort](https://github.com/instructure/canvas-lms/blob/master/app/controllers/account_reports_controller.rb)

### PUT /api/v1/accounts/:account\_id/reports/:report/:id/abort
