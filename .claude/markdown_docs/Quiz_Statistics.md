...
These statistics are extracted (and composed) from *graded* (manually or, when
...
## [Fetching the latest quiz statistics](#method.quizzes/quiz_statistics.index) [Quizzes::QuizStatisticsController#index](https://github.com/instructure/canvas-lms/blob/master/app/controllers/quizzes/quiz_statistics_controller.rb)

### GET /api/v1/courses/:course\_id/quizzes/:quiz\_id/statistics
...
| --- | --- | --- | --- |
| all\_versions |  | boolean | Whether the statistics report should include all submissions attempts. |
