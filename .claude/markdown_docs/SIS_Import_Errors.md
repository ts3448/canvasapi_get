...
## [Get SIS import error list](#method.sis_import_errors_api.index) [SisImportErrorsApiController#index](https://github.com/instructure/canvas-lms/blob/master/app/controllers/sis_import_errors_api_controller.rb)

### GET /api/v1/accounts/:account\_id/sis\_imports/:id/errors

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/sis_imports/:id/errors`

### GET /api/v1/accounts/:account\_id/sis\_import\_errors
...
Returns a list of
[SisImportError](sis_import_errors.html#SisImportError)
objects