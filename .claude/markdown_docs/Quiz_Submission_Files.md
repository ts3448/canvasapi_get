...
## [Upload a file](#method.quizzes/quiz_submission_files.create) [Quizzes::QuizSubmissionFilesController#create](https://github.com/instructure/canvas-lms/blob/master/app/controllers/quizzes/quiz_submission_files_controller.rb)

### POST /api/v1/courses/:course\_id/quizzes/:quiz\_id/submissions/self/files
...
| on\_duplicate |  | string | How to handle duplicate names |
