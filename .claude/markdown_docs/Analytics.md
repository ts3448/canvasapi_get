...
## [Get department-level participation data](#method.analytics_api.department_participation)

### GET /api/v1/accounts/:account\_id/analytics/terms/:term\_id/activity

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/analytics/terms/:term_id/activity`

### GET /api/v1/accounts/:account\_id/analytics/current/activity

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/analytics/current/activity`

### GET /api/v1/accounts/:account\_id/analytics/completed/activity
...
## [Get department-level grade data](#method.analytics_api.department_grades)

### GET /api/v1/accounts/:account\_id/analytics/terms/:term\_id/grades

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/analytics/terms/:term_id/grades`

### GET /api/v1/accounts/:account\_id/analytics/current/grades

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/analytics/current/grades`

### GET /api/v1/accounts/:account\_id/analytics/completed/grades
...
## [Get department-level statistics](#method.analytics_api.department_statistics)

### GET /api/v1/accounts/:account\_id/analytics/terms/:term\_id/statistics

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/analytics/terms/:term_id/statistics`

### GET /api/v1/accounts/:account\_id/analytics/current/statistics

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/analytics/current/statistics`

### GET /api/v1/accounts/:account\_id/analytics/completed/statistics
...
## [Get department-level statistics, broken down by subaccount](#method.analytics_api.department_statistics_by_subaccount)

### GET /api/v1/accounts/:account\_id/analytics/terms/:term\_id/statistics\_by\_subaccount

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/analytics/terms/:term_id/statistics_by_subaccount`

### GET /api/v1/accounts/:account\_id/analytics/current/statistics\_by\_subaccount

**Scope:** 
`url:GET|/api/v1/accounts/:account_id/analytics/current/statistics_by_subaccount`

### GET /api/v1/accounts/:account\_id/analytics/completed/statistics\_by\_subaccount
...
## [Get course-level assignment data](#method.analytics_api.course_assignments)

### GET /api/v1/courses/:course\_id/analytics/assignments
...
## [Get course-level student summary data](#method.analytics_api.course_student_summaries)

### GET /api/v1/courses/:course\_id/analytics/student\_summaries
...
| Parameter |  | Type | Description |
| --- | --- | --- | --- |
| sort\_column |  | string | The order results in which results are returned. Defaults to ânameâ.  Allowed values: `name`, `name_descending`, `score`, `score_descending`, `participations`, `participations_descending`, `page_views`, `page_views_descending` |
| student\_id |  | string | If set, returns only the specified student. |
...
## [Get user-in-a-course-level participation data](#method.analytics_api.student_in_course_participation)

### GET /api/v1/courses/:course\_id/analytics/users/:student\_id/activity
...
âpage\_views` are returned as a hash, where the keys are iso8601 dates, bucketed by the hour. `participations` are returned as an array of hashes, sorted oldest to newest.
...
## [Get user-in-a-course-level assignment data](#method.analytics_api.student_in_course_assignments)

### GET /api/v1/courses/:course\_id/analytics/users/:student\_id/assignments
...
## [Get user-in-a-course-level messaging data](#method.analytics_api.student_in_course_messaging)

### GET /api/v1/courses/:course\_id/analytics/users/:student\_id/communication
