...
## [List collaborations](#method.collaborations.api_index) [CollaborationsController#api\_index](https://github.com/instructure/canvas-lms/blob/master/app/controllers/collaborations_controller.rb)

### GET /api/v1/courses/:course\_id/collaborations

**Scope:** 
`url:GET|/api/v1/courses/:course_id/collaborations`

### GET /api/v1/groups/:group\_id/collaborations
...
Returns a list of
[Collaboration](collaborations.html#Collaboration)
objects

## [List members of a collaboration.](#method.collaborations.members) [CollaborationsController#members](https://github.com/instructure/canvas-lms/blob/master/app/controllers/collaborations_controller.rb)
...
Returns a list of
[Collaborator](collaborations.html#Collaborator)
objects

## [List potential members](#method.collaborations.potential_collaborators) [CollaborationsController#potential\_collaborators](https://github.com/instructure/canvas-lms/blob/master/app/controllers/collaborations_controller.rb)

### GET /api/v1/courses/:course\_id/potential\_collaborators

**Scope:** 
`url:GET|/api/v1/courses/:course_id/potential_collaborators`

### GET /api/v1/groups/:group\_id/potential\_collaborators
